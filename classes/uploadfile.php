    ...
    class Uploadfile{
        public static function process(){
            try {
                ...
                $rs = Errorfileupload::err($_FILES['imagefile']['error']);
                if ($rs != 'OK') {
                    Dialog::show($rs);
                    return null;
                }
                ...
                if ($_FILES['imagefile']['size'] > $fileMaxSize) {
                ...
                $file_mime_type = finfo_file($fileinfo, $_FILES['imagefile']['tmp_name']);
